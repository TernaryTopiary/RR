...
public class CameraMovement : MonoBehaviour
{
    ...
    private const int ScrollArea = 15;
    ...
    private void Start()
    {
        cursorTexture = Resources.Load("Textures/Interface/Pointers/Aclosed") as Texture2D;
    ...
    private void Update()
    {
        ...
        {
            transform.eulerAngles = new Vector3(pan, 180, 0);
        }
