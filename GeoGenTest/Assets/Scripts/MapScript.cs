...
public class MapScript : MonoBehaviour
{
    ...
    private void Select(GameObject gameObject)
    {
        ...
        var tile = Map.Tiles[(int)location.x, (int)location.y];
	...
	void Update () {
        ...
        MaterialManager.GetWaterTile(MaterialManager.Biome.ROCK).SetTextureOffset("_MainTex", new Vector2(2 * offset, 0));
        MaterialManager.GetLavaTile(MaterialManager.Biome.ROCK).SetTextureOffset("_MainTex", new Vector2(offset, 0));
        MaterialManager.GetWaterTile(MaterialManager.Biome.ICE).SetTextureOffset("_MainTex", new Vector2(2 * offset, 0));
        MaterialManager.GetLavaTile(MaterialManager.Biome.ICE).SetTextureOffset("_MainTex", new Vector2(offset, 0));
        MaterialManager.GetWaterTile(MaterialManager.Biome.LAVA).SetTextureOffset("_MainTex", new Vector2(2 * offset, 0));
        MaterialManager.GetLavaTile(MaterialManager.Biome.LAVA).SetTextureOffset("_MainTex", new Vector2(offset, 0));
