...
namespace Assets.Scripts.Extensions
{
    public static class Geometry
    {
        ...
        public static Vector3 Average(Vector3 vector1, Vector3 vector2) => new Vector3(Average(vector1.x, vector2.x), Average(vector1.x, vector2.x), Average(vector1.x, vector2.x));
